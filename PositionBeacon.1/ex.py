...
with tf.Session() as sess:
    ...
    saver.restore(sess, "PositionBeacon.1/tmp/model.ckpt")
            ...
            if done:
                ...
                for epoch in range(10):
                    ...
                    PPO.train(obs=sampled_inp[0],
                            ...
                            gaes=sampled_inp[5])
                saver.save(sess, "PositionBeacon.1/tmp/model.ckpt")
                print(episodes, sum(rewards))
                open_file_and_save('PositionBeacon.1/reward.csv', [sum(rewards)])
